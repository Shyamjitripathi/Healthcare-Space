...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">Healthcare Space</a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <h1 style="color:rgb(18, 38, 54);">Welcome Jhansi Residents</h1>
      <h2>One stop, where all your health related issues resolves</h2>
  ...
  <main id="main">
              ...
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Intensive Research</h4>
                    <p>About Doctor qualifications, staff efficency and types of services provided.</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Survey</h4>
                    <p>Services quality standard,Hygiene Maintenance, food and water availability</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div
            ...
            <div class="icon-box">
              <div class="icon"><i class="bx"><img src="png/doctors.png" style="width: 60px;"></i></div>
              <h4 class="title"><a href="">Doctors</a></h4>
              <p class="description">Access 100% verified doctors service.</p>
            </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="icon-box">
              ...
              <h4><a href="">Maharani Laxmi Bai Medical college Hospital Jhansi</a></h4>
              <p> Anesthesiology,
                Bio-Chemistry,
                Dentistry,
                Dermatology (Skin),
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <h4><a href="">Dr. Vinod Sahu Multispeciality Hospital Jhansi</a></h4>
              <p> General Medicine,
                Obstetrics and Gynecology,
                Ophthalmology,
                Orthopedics,
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <h4><a href="">Chiranjeev Hospital,Jhansi</a></h4>
              <p> General Medicine,
                General Surgery,
                Gynecology,
                Obstetrics and Gynecology,
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <h4><a href="">Meghraj Memorial Sharad Gastro And Liver Care Centre, Jhansi</a></h4>
              <p>Endoscopy,
                Gastroenterology,
                Pathology,
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <h4><a href=""> Dr. Jiya Lal Memorial Hospital, Jhansi</a></h4>
              <p> Ophthalmology
                Lasik-laser,
                Trabeculectomy,
                Lasek,
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <h4><a href="">Raghvendra Hospital (Laparoscopic Surgery Centre), Jhansi</a></h4>
              <p> Allergy,
                Breast Surgery,
                Cardiology,
                Chest Physician,
          ...
          <div class="row">
            ...
            <div class="col-md-4 form-group mt-3">
              <select name="department" id="department" class="form-select">
                ...
                <option value="Department 3">Gynḍecology</option>
                <option value="Department 4">Gastroduodenoscopy</option>
              </select>
              <div class="validate"></div>
            </div>
            <div class="col-md-4 form-group mt-3">
              <select name="doctor" id="doctor" class="form-select">
                ...
                <option value="Doctor 1">Dr.Rampratap Singh (MBBS,MD)</option>
                <option value="Doctor 2">Dr. Saurabh Srivastava(MBBS,MD)</option>
                <option value="Doctor 3">Dr.Sharad chandra (MBBS,MD)</option>
              </select>
              <div class="validate"></div>
            </div>
          </div>
    ...
    <section id="doctors" class="doctors">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Best Doctors</h2>
          <p>These are the best doctors in various field working in Jhansi </p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            <div class="member d-flex align-items-start">
              ...
              <div class="member-info">
                ...
                <span>Gastroenterologists</span>
                <p>Upper GI Endoscopy, Colonoscopy, ERCP, GI Bleeding, Metallic Stenting.</p>
                <div class="social">
                  <a href=""><i class="ri-twitter-fill"></i></a>
                  <a href=""><i class="ri-facebook-fill"></i></a>
                  <a href=""><i class="ri-instagram-fill"></i></a>
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start">
              ...
              <div class="member-info">
                ...
                <span>Gastroenterologists</span>
                <p>Colonoscopy, Abdominal Pain Treatment, Liver Transplant, Irritable Bowel Syndrome (IBS).</p>
                <div class="social">
                  <a href=""><i class="ri-twitter-fill"></i></a>
                  <a href=""><i class="ri-facebook-fill"></i></a>
                  <a href=""><i class="ri-instagram-fill"></i></a>
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="assets/img/doctors/dr-abhisek.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Dr.Abhisek Singh (MBBS,MD) </h4>
                <span>Neurosurgeon</span>
                <p>Spine and Pain Specialist Neurology Spine Surgery Pediatric Neurology.</p>
                <div class="social">
                  <a href=""><i class="ri-twitter-fill"></i></a>
                  <a href=""><i class="ri-facebook-fill"></i></a>
                  <a href=""><i class="ri-instagram-fill"></i></a>
            ...
            <li data-aos="fade-up">
              ...
              <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                <p>
                  ...
                  4.Get good sleep.<br>
                  4.Ditch the alcohol.<br>
                  5.Address allergies.<br>
                  6.Reduce stress.<br>
                </p>
              </div>
            </li>
        ...
        <div class="testimonials-slider swiper" data-aos="fade-up" data-aos-delay="100">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="assets/img/testimonials/images1.jpg" class="testimonial-img" alt="">
                  <h3>Neha Dubey</h3>
                  <h4>Student</h4>
                  <p>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="assets/img/testimonials/image2.jpg" class="testimonial-img" alt="">
                  <h3>Shansank Sharma </h3>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="assets/img/testimonials/images3.jpg" class="testimonial-img" alt="">
                  <h3>Suresh Kumar</h3>
                  <h4>Store Owner</h4>
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="assets/img/testimonials/images4.jpg" class="testimonial-img" alt="">
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="assets/img/testimonials/images5.jpg" class="testimonial-img" alt="">
                  <h3>Shivam Kumar</h3>
                  <h4>Entrepreneur</h4>
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
    ...
    <section id="gallery" class="gallery">
      ...
      <div class="container-fluid">
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assets/img/gallery/hospital1.jpg" class="galelry-lightbox">
                <img src="assets/img/gallery/hospital1.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assets/img/gallery/hospital2.jpg" class="galelry-lightbox">
                <img src="assets/img/gallery/hospital2.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assets/img/gallery/hospital3.jpg" class="galelry-lightbox">
                <img src="assets/img/gallery/hospital3.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assets/img/gallery/hospital4.jpg" class="galelry-lightbox">
                <img src="assets/img/gallery/hospital4.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Our Services</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Verified Hospitals List</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Trusted Doctors</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Simplified Rate chart</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Feedback System</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Infrastructure Dashboards</a></li>
            </ul>
          </div>

          <div class="col-lg-4 col-md-6 footer-newsletter">
            <h4>Give us feedback</h4>
            <p>Give your valuable feedback to us </p>
            <form action="" method="post">
              <input type="email" name="email"><input type="submit" value="Post">
            </form>
          </div>
